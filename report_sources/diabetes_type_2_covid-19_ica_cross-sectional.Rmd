...
# Exploration of hemoglobin by group
p3 <- group_stat_table_plot(data, "hemoglobina", "a_f")

# Exploration of hematocrit by group
p4 <- group_stat_table_plot(data, "hematocrito", "a_f")
...
# Exploration of PaO by group
p3 <- group_stat_table_plot(data, "PaO2", "a_f")

# Exploration of FiO2_aga by group
